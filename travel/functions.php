...
/* файл функций, для работы системы  */



/**
* описываем функцию, загружаемые стили и скрипты
**/
...
/**
* загружаем стили и скрипты, привязываем нашу(пользовательскую) функцию к хуку встроеной функции
**/
add_action('wp_enqueue_scripts', 'load_style_script');


/**
* подержка(вывод) миниатюры
**/
add_theme_support('post-thumbnails');


/**
* регистрируем вывод 1го меню(если нужен вывод больше меню используем register_nav_menus())
**/
...
register_sidebar(array(
	...
	'before_widget' => '<div class="f_menu f_menu_cat">',
	'after_widget' => '</div>',
	'before_title' => '<h2>',
	'after_title' => '</h2>'
));
...
/**
* commets, можно вытащить с другого шаблона
**/
...
/**
* slider добавляем новый тип записей в меню админки
**/
